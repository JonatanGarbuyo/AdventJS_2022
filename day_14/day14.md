...
Cada reno comienza en la cima de la pirámide y debe elegir el camino óptimo hacia abajo para recorrerlo _**en el menor tiempo posible**_. Cada nivel tiene un número que determina el tiempo que necesita para llegar ahí.

Al llegar a una posición, el reno _**solo puede deslizarse hacia abajo y en diagonal hacia la izquierda o la derecha**_. Visualmente, la pirámide se ve así:
